$(document).ready(function() {
  ...
  var TITLE = 'Median Prices of Houses in US, 2010 and 2020';
  ...
  var SERIES = [  
    ...
    {
      column: 'Aug2020 Home Value',
      name: 'Aug 2020 Home Value',
      color: 'blue'
    }
  ];
  ...
  $.get('./bar chart - homevalueindex-zillow-states-2019-20 - data.csv', {'_': $.now()}, function(csvString) {
